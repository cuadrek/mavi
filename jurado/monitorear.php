...
<body>
			...
			<div id="panelPrincipal">
				<div id="competencia_principal">
					<div id="competencia_menu">
						<? include("submenu_jurado.php"); ?>
					</div>
					<div id="competencia_centro">
						<? /*********** DIV CENTRAL *********/ ?>
						<p><span id="pregunta" name="pregunta">
							...
							<select name="maratones_sl" id="maratones_sl">
								...
								?>
								<option value="<?=$maratones["id"]?>"><?=$maratones["nombre_tema"]?></option>
								<?
									}
									mysql_close();
								?>
	...
	<script type="text/javascript" src="../script/ajaxScript.js"></script>
